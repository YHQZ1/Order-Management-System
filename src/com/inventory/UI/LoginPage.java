...
public class LoginPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Admin", "Customer", "Vendor", " " }));
    ...
    // You can add password encryption later here if needed
    ...
    if (new ConnectionFactory().checkLogin(username, password, userType)) {
        ...
        switch (userType.toLowerCase()) {
            ...
            case "customer":
                new Dashboard1(username, userType, userDTO).setVisible(true);
                break;

            case "vendor":
                new Dashboard2(username, userType, userDTO).setVisible(true);
                break;
