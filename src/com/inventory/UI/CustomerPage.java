...
public class CustomerPage extends javax.swing.JPanel {
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        if (codeText.getText().equals("") || nameText.getText().equals("")
            ...
            customerDTO.setCustomerID(Integer.parseInt(codeText.getText()));
            customerDTO.setName(nameText.getText());
            customerDTO.setPhone(phoneText.getText());
            customerDTO.setAddress(locationText.getText());
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        if (custTable.getSelectedRow()<0)
            ...
            if (opt==JOptionPane.YES_OPTION) {
                new CustomerDAO().deleteCustomerDAO((int)custTable.getValueAt(custTable.getSelectedRow(),0));
                loadDataSet();
            }
        }
...
if (row < 0) return;  // Simple check if no row is selected
...
// Safe casting to String with null checks
codeText.setText(data[0] == null ? "" : data[0].toString());
nameText.setText(data[1] == null ? "" : data[1].toString());
locationText.setText(data[2] == null ? "" : data[2].toString());
phoneText.setText(data[3] == null ? "" : data[3].toString());
emailText.setText(data[4] == null ? "" : data[4].toString());
